...
<div class="cont_main">
	<div class="content">
		<img src="Images/about.png" height="70px"  />
			<h4><span class="bold">Word from the Founders</span></h4>
			<p><img src="Images/lol.jpg" height="200px" style="margin-bottom:40px" /></a><b>"Share Life"</b> is the first product resulted out of the community welfare initiative called 'People Projects'. Universally, 'Blood' is recognized as the most precious element that sustains life. It saves innumerable lives across the world in a variety of conditions. Once in every 2- seconds, someone, somewhere is desperately in need of blood. More than 29 million units of blood components are transfused every year. The need for blood is great - on any given day, approximately 39,000 units of Red Blood Cells are needed.</p>
...
<div class="footer">
	<div class="f_nav">
		...
		<div class="copy">
			<p class="title">© All Rights Reserved.<br> Made by DEPT of cse.NDUB. </p>
		</div>
	<div class="clear"></div>
</div>
</div>
